...
exports.getBillingMetrics = exports.logAuditEvent = void 0;
const database_1 = __importDefault(require("../config/database"));
// Central audit logging event helper
const logAuditEvent = async (client, userId, action, resource, metadata = {}) => {
    try {
        const dbClient = client || database_1.default;
