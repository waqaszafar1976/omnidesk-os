...
exports.initializeDatabase = exports.query = void 0;
...
const parseSqlValues = (sql, params) => {
    ...
    return tokens.map(t => {
        ...
        if (t.toLowerCase() === 'null')
            return null;
        if (t.toLowerCase() === 'current_timestamp')
            return new Date();
...
const executeMockQuery = async (text, params = []) => {
    ...
    if (sqlLower.includes('insert into consumption_metrics') || sqlLower.includes('update consumption_metrics')) {
        ...
        if (metric) {
            ...
            metric = { id: (0, uuid_1.v4)(), workspace_id, resource_type, usage_count, last_updated: new Date() };
